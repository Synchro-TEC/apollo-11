...
var OptionSelector = (function (_React$Component) {
  ...
  function OptionSelector(props) {
    ...
    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(OptionSelector).call(this, props));
    ...
    value: function render() {
      ...
      var options = this.props.options.map(function (opt, i) {
        return _react2.default.createElement(
          ...
          { key: 'opt-' + i, onClick: function onClick() {
              return _this2.onSelect(opt.value);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'button',
          { className: 'sv-button small default', onClick: function onClick() {
