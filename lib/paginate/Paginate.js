...
var Paginate = function (_React$Component) {
  ...
  function Paginate(props) {
    ...
    _this.currentPage = 1;
    _this.totalOfPieces = Math.ceil(_this.props.totalSizeOfData / _this.props.recordsByPage);
    return _this;
  }
  ...
  _createClass(Paginate, [{
    ...
    value: function mountPaginateInfo() {
      var recordsByPage = this.props.recordsByPage;
...
Paginate.propTypes = {
  ...
  recordsByPage: _react2.default.PropTypes.number,
