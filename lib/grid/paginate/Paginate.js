  ...
  _createClass(Paginate, [{
    ...
    value: function render() {
      ...
      if (this.totalOfPieces - this.currentPage <= 2) {
        ...
        for (var _i = this.totalOfPieces - 4; _i <= this.totalOfPieces; _i++) {
        ...
        paginationOptions.push(this.colorPaginationOptionAndPutGapIfNeeded('...'));
        for (var _i3 = this.currentPage - 2; _i3 <= this.totalOfPieces; _i3++) {
        ...
        for (var _i5 = 2; _i5 >= -2; _i5--) {
          paginationOptions.push(this.colorPaginationOptionAndPutGapIfNeeded(this.currentPage - _i5));
        }
        paginationOptions.push(this.colorPaginationOptionAndPutGapIfNeeded('...'));
      } else if (this.currentPage <= 6 && this.currentPage >= 3) {
        for (var _i6 = this.currentPage + 2; _i6 >= 1; _i6--) {
          paginationOptions.unshift(this.colorPaginationOptionAndPutGapIfNeeded(_i6));
        }
        paginationOptions.push(this.colorPaginationOptionAndPutGapIfNeeded('...'));
      } else if (this.currentPage <= 2) {
        for (var _i7 = 1; _i7 <= 5; _i7++) {
          paginationOptions.push(this.colorPaginationOptionAndPutGapIfNeeded(_i7));
        }
        paginationOptions.push(this.colorPaginationOptionAndPutGapIfNeeded('...'));
      }

      for (var _i8 = 1; _i8 >= 0; _i8--) {
        paginationOptions.push(this.colorPaginationOptionAndPutGapIfNeeded(this.totalOfPieces - _i8));
      }
