    ...
    value: function colorPaginationOptionIfNeeded(i) {
      ...
      if (this.currentPage === i) {
        option = _react2.default.createElement(
          'li',
          { key: (0, _uniqueId3.default)(), style: _PaginateStyles2.default.options },
    ...
    value: function render() {
      ...
      if (this.currentPage === 1) {
        ...
        if (this.currentPage % 5 === 0) {
          for (var _i = this.currentPage; _i >= this.currentPage - 4; _i--) {
            paginationOptions.unshift(this.colorPaginationOptionIfNeeded(_i));
          }
        } else {
          for (var _i2 = this.currentPage - 1; _i2 > 0; _i2--) {
            debugger;
            if (_i2 === 1) {
              paginationOptions.unshift(this.colorPaginationOptionIfNeeded(_i2));
              break;
            }
            if (_i2 % 5 === 0) {
              break;
          ...
          for (var _i3 = this.currentPage; _i3 >= this.currentPage; _i3++) {
            if (_i3 % 5 === 0) {
              paginationOptions.push(this.colorPaginationOptionIfNeeded(_i3));
              break;
            }
            paginationOptions.push(this.colorPaginationOptionIfNeeded(_i3));
          }
