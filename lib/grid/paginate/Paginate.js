  ...
  _createClass(Paginate, [{
    ...
    value: function render() {
      ...
      if (this.totalOfPieces <= 10) {
        for (var i = this.totalOfPieces - 2; i >= 1; i--) {
        ...
        for (var _i2 = this.totalOfPieces - 4; _i2 <= this.totalOfPieces - 2; _i2++) {
        ...
        paginationOptions.push(this.colorPaginationOptionAndPutGapIfNeeded('...'));
        for (var _i4 = this.currentPage - 2; _i4 <= this.totalOfPieces - 2; _i4++) {
