...
var DataTableColumn = function (_React$Component) {
  ...
  _createClass(DataTableColumn, [{
    ...
    value: function onSort() {
      ...
      var executeSort = void 0;

      if (this.props.onSort) {
        executeSort = function executeSort() {
          var sortInfo = {};
          sortInfo.columnKey = _this2.props.dataKey;
          sortInfo.direction = _this2.state.direction;
          _this2.props.onSort(sortInfo);
        };
      }
