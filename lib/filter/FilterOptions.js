...
var _filterStyles = require('./filter-styles');

var _filterStyles2 = _interopRequireDefault(_filterStyles);
...
var FilterOptions = function (_React$Component) {
  ...
  _createClass(FilterOptions, [{
    ...
    value: function render() {
      ...
      var filterOptionsStyles = Object.assign({ width: '100%' }, { display: this.state.isOpen ? 'block' : 'none' });

      var filterSpanStyles = Object.assign({}, { display: this.props.hasFilterOptions ? 'block' : 'none' }, { color: this.state.isOpen ? '#2196f3' : '#455a64' });
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'span',
          { className: 'label-action at-last', onClick: function onClick() {
